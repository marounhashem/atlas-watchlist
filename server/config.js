const SYMBOLS = {
  GOLD: {
    ...
    peakSession: 'london',
    scoringWeights: { pine: 0.45, fxssi: 0.40, session: 0.15 },
  ...
  EURUSD: {
    ...
    peakSession: 'london', scoringWeights: { pine: 0.45, fxssi: 0.40, session: 0.15 },
  ...
  USDJPY: {
    ...
    assetClass: 'forex', sessions: { london: true, newYork: true, asia: true },
    peakSession: 'asia', scoringWeights: { pine: 0.45, fxssi: 0.40, session: 0.15 },
  ...
  USDCAD: {
    ...
    assetClass: 'forex', sessions: { london: true, newYork: true, asia: false },
    peakSession: 'newYork', scoringWeights: { pine: 0.45, fxssi: 0.40, session: 0.15 },
